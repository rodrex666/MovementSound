...
// Method Definition Index: 2792
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR bool Array_InternalArray__ICollection_Contains_TisMeshGroup_t325E59B83D2A719D665B34633AE978A26868230C_mAD75DA9E3DE4037922346F56038E87CCBA2B1318_gshared (RuntimeArray* __this, MeshGroup_t325E59B83D2A719D665B34633AE978A26868230C ___0_item, const RuntimeMethod* method) 
{
	il2cpp_rgctx_method_init(method);
	int32_t V_0 = 0;
	int32_t V_1 = 0;
	MeshGroup_t325E59B83D2A719D665B34633AE978A26868230C V_2;
	memset((&V_2), 0, sizeof(V_2));
	{
		int32_t L_0;
		L_0 = Array_get_Rank_m9383A200A2ECC89ECA44FE5F812ECFB874449C5F(__this, NULL);
...
IL_003a:
	{
		MeshGroup_t325E59B83D2A719D665B34633AE978A26868230C L_5 = V_2;
		MeshGroup_t325E59B83D2A719D665B34633AE978A26868230C L_6 = L_5;
		RuntimeObject* L_7 = Box(il2cpp_rgctx_data_no_init(method->rgctx_data, 1), &L_6);
		Il2CppFakeBox<MeshGroup_t325E59B83D2A719D665B34633AE978A26868230C> L_8(il2cpp_rgctx_data(method->rgctx_data, 1), (&___0_item));
		bool L_9;
		L_9 = ValueType_Equals_mCA5344597A8055EC544855AD60A983B10E0EE67D((ValueType_t6D9B272BD21782F0A9A14F2E41F85A50E97A986F*)(&L_8), L_7, NULL);
		if (!L_9)
		{
